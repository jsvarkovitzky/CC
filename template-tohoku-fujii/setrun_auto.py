...
#    geodata.dtopofiles.append([1,3,3,fname])
    ...
    ## Whole World ##
    geodata.regions.append([1, 1, 0., 1e9, 0, 360, -90, 90])

    ## Tohoku Source Area ##
    geodata.regions.append([3, 3, 0., 1800, 140, 146, 30, 42])

    ## CA Coastal Refinement Regions ##
    ...
    #Note this arrangement is to track a wave from Japan towards CA
    ...
    ## Regions of Moderate Refinement Near CA Coast ##
